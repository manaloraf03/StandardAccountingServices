...
class General_journal extends CORE_Controller
{
    ...
    public function get_response_rows($criteria=null,$additional=null){
        ...
        return $m_journal->get_list(
            ...
            "journal_info.is_deleted=FALSE AND journal_info.is_active= TRUE AND journal_info.book_type='GJE'".($criteria==null?'':' AND journal_info.journal_id='.$criteria)."".($additional==null?'':$additional),

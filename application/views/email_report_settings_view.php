            ...
            <div class="static-content"  >
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 0px;">
                        ...
                        <li><a href="Email_report_settings">Email Report Settings  <?php //print_r($user_groups); ?></a></li>
                    </ol>
                                               ...
                                               <form id="frm_company" role="form" class="form-horizontal row-border">
                                                   <div class="form-group hidden">
                                                       ...
                                                       <div class="col-md-7">
                                                           ...
                                                           <select id="cbo_email_provider_to" class="form-control" name="email_provider_to">
                                                               <option value="ssl://smtp.googlemail.com" data-value="@gmail.com"><i class="ti ti-google"></i> Gmail</option>
                                                               <option value="ssl://smtp-mail.outlook.com" data-value="@outlook.com"><i class="ti ti-microsoft-alt"></i> Outlook</option>
                                                               <option value="ssl://smtp.mail.yahoo.com." data-value="@yahoo.com"><i class="ti ti-yahoo"></i> Yahoo</option>
                                                           </select>
                                                   ...
                                                   <div class="form-group">
                                                       <label class="col-md-2 col-md-offset-1 control-label"><strong>* Email Address (To) :</strong></label>
                                                       <div class="col-md-5">
                                                           <div class="input-group">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-users"></i>
                                                                </span>
                                                                <input type="text" name="email_to" class="form-control" value="<?php echo $company->email_to; ?>" placeholder="Email Address" data-error-msg="Email Address To is required!" required>
                                                           </div>
                                                       </div>
                                                       <div class="col-md-1" style="margin-top: 5px;">
                                                           <span><strong id="provider_string_to"></strong></span>
                                                       </div>
                                                   </div>
    ...
    $(document).ready(function(){
        ...
        var initializeControls=function(){
            $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Email_report_settings/transaction/get-email"
                ...
                $('#cbo_email_provider_to option[value="'+response.data.email_provider_to+'"]').prop('selected',true);
                $('#provider_string_to').html($('#cbo_email_provider_to option:selected').data('value'));
                $('input[name="email_to"]').val(response.data.email_to.split('@')[0]);
        ...
        var bindEventHandlers=function(){
            ...
            $('#cbo_email_provider_to').on('change',function(){
                $('#provider_string_to').html($('#cbo_email_provider_to option:selected').data('value'));
            });
            ...
            $('input[name="email_to"]').on('keydown',function(event){
                if (event.shiftKey && event.keyCode === 50){
                    event.preventDefault();
                }
            });
        ...
        var createCompanyInfo=function(){
            ...
            _data.push({name:'email_to',value: $('input[name="email_to"]').val() + $('#provider_string').html() });


            return $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Email_report_settings/transaction/create",
                "data":_data,

...
<!--                 <div class="panel-heading" style="background: #2ecc71;border-bottom: 1px solid lightgrey;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                            Search :<br />
                             <input type="text" id="searchbox_accounts_receivable" class="form-control">
                    </div>
                </div><br>
...
$(document).ready(function(){
        ...
        dt=$('#tbl_accounts_receivable').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    targets:[7],
                    render: function (data, type, full, meta){
                        var btn_edit='<button class="btn btn-primary btn-sm <?php  echo ($this->session->user_group_id==1?'':'remove_button_validate') ?>" name="edit_info"  style="margin-left:-15px;" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i> </button>';
    ...
    var bindEventHandlers=function(){
        ...
        $("#searchbox_accounts_receivable").keyup(function(){         
            dt
                .search(this.value)
                .draw();
        });

    ...
    <center>
        <table width="95%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11" >
            ...
            <tr>
                ...
                <td colspan="2" style="padding: 6px;border-bottom: 1px solid gray;height: 30px;border-left: 1px solid gray;" align="left">Discount (%)</td>
                <td style="padding: 6px;border-bottom: 1px solid gray;height: 30px;border-right: 1px solid gray;" align="right"><strong><?php echo number_format($delivery_info->total_overall_discount,2); ?></strong></td>
            </tr>
            <tr>
                <td align="left" colspan="2" style="border-left: 1px solid gray;"></td>
                <td colspan="2" style="padding: 6px;border-bottom: 1px solid gray;height: 30px;border-left: 1px solid gray;" align="left">Total After Discount</td>
                <td style="padding: 6px;border-bottom: 1px solid gray;height: 30px;border-right: 1px solid gray;" align="right"><strong><?php echo number_format($delivery_info->total_after_discount,2); ?></strong></td>
            </tr>
            <tr>
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;border-right: 1px solid gray;"><?php echo number_format($delivery_info->total_discount,2); ?></td>
            </tr>
            <tr>
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;border-right: 1px solid gray;"><?php echo number_format($delivery_info->total_before_tax,2); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 30px;padding: 6px;border-right: 1px solid gray;"><strong><?php echo number_format($delivery_info->total_after_tax,2); ?></strong></td>
            </tr>
            </tfoot>
        </table><br /><br />
    </center>

                    ...
                    <ul class="acc-menu">
                        ...
                        <li class="<?php echo (in_array('1',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-wallet"></i><span>Financing</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('1-7',$this->session->user_rights)?'':'hidden'); ?>"><a href="Trash_bin">Trash Bin</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="<?php echo (in_array('2',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-package"></i><span>Purchasing</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('2-7',$this->session->user_rights)?'':'hidden'); ?>"><a href="Purchase_history">Purchase History</a></li>
                        ...
                        <li class="<?php echo (in_array('6',$this->session->parent_rights)?'':'hidden'); ?>">
                            ...
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('6-12',$this->session->user_rights)?'':'hidden'); ?>"><a href="Soa_settings">SOA Settings</a></li>

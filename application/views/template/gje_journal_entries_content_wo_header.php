...
*/
    ...
    <table width="100%" border="0" cellspacing="-1">
        <tr>
            <td style="padding: 4px;" width="50%" colspan="2"><strong>DATE :</strong> <?php echo date_format(new DateTime($journal_info->date_txn),"m/d/Y"); ?></td>
...
<!--         <tr>
        ...
        <tr>
            <td style="padding: 4px;" width="50%" colspan="2"><strong>TXN # :</strong> <?php echo $journal_info->txn_no; ?></td>
